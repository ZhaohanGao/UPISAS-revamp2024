...
def execute():
    try:
        ...
        if req.operation == "addInstances":
            ...
            # url = "http://sefa-instances-manager:58015/rest/addInstances"
            url = "http://172.25.0.1:58015/rest/addInstances"
            headers = {
            ...
            # url = "http://sefa-config-manager:58016/rest/changeLBWeights"
            url = "http://172.25.0.1:58016/rest/changeLBWeights"
            headers = {
                'Content-Type': 'application/json'
            }
            request_body = {
            ...
            # URL = "http://sefa-config-manager:58016/rest/changeProperty"
            URL = "http://172.25.0.1:58016/rest/changeProperty"
            headers = {
                'Content-Type': 'application/json'
            }
            request_body = {
            ...
            # url = "http://sefa-instances-manager:58015/rest/removeInstance"
            url = "http://172.25.0.1:58015/rest/removeInstance"
            headers = {
                'Content-Type': 'application/json'
            }
            request_body = {
...
def fetch_system_architecture():
    # url = "http://sefa-probe:58020/rest/systemArchitecture"
    url = "http://172.18.0.11:58020/rest/systemArchitecture"
...
def fetch_instance_configuration(serviceName, implementationId):
    # url = "http://sefa-probe:58020/rest/service/{}/configuration?implementationId={}".format(serviceName,
    #                                                                                         implementationId)
    url = "http://172.18.0.11:58020/rest/service/{}/configuration?implementationId={}".format(serviceName,
                                                                                            implementationId)
    try:
        response = requests.get(url)
        response.raise_for_status()
...
def fetch_service_snapshot(serviceName):
    # url = "http://sefa-probe:58020/rest/service/{}/snapshot".format(serviceName)
    url = "http://172.18.0.11:58020/rest/service/{}/snapshot".format(serviceName)
    try:
        response = requests.get(url)
        response.raise_for_status()
